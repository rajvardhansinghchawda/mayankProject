...
const Sidebar = () => {
  ...
  return (
    <aside className="bg-slate-100 dark:bg-slate-950 text-primary dark:text-blue-400 font-body text-sm font-medium h-screen w-64 fixed left-0 top-0 z-40 border-r-0 bg-slate-100 dark:bg-slate-900 flat no-shadows flex flex-col p-4 space-y-2 pt-24">
